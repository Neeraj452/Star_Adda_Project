          ...
          <div className="m-3">
            ...
            <>
              ...
              <p className="p4">
                ...
                bound by these Terms and Zuss.in Privacy Policy, as stated on
                paragraph 5.
              </p>
              <p className="p4">
              ...
              <ul className="ul1">
                ...
                <li className="li4">
                  Zuss.in DOES NOT OFFER POKER FOR STAKES WITHIN THE TERRITORY
                  OF GUJARAT. THE RESIDENTS OF GUJARAT HOWEVER ARE NOT
                  RESTRICTED FROM PLAYING THE FREE TO PLAY FORMAT OF POKER,
                  OFFERED BY Zuss.in.
                </li>
                <li className="li4">
                  Zuss.in DOES NOT OFFER RUMMY FOR STAKES WITHIN THE TERRITORY
                ...
                <li className="li4">
                  ...
                  Zuss.in SHALL IN ITS SOLE DISCRETION HAVE THE RIGHT TO
                ...
                <li className="li4">
                  ...
                  PARTICIPATING IN THE CONTEST AND Zuss.in MAY TAKE LEGAL ACTION
                  AGAINST YOU.
                </li>
                <li className="li4">
                  EMPLOYEES OF Zuss.in, ITS RESPECTIVE HOLDING, SUBSIDIARIES,
                  ASSOCIATE COMPANIES AND THIRD-PARTY SERVICE PROVIDERS WHO HAVE
                  BEEN ENGAGED BY Zuss.in FOR THE DEVELOPMENT, PROMOTION,
                ...
                <li className="li4">
                  ...
                  zuss.in PRIVATE LIMITED’S DECISION SHALL BE FINAL AND BINDING.
                </li>
                <li className="li4">
                  Zuss.in RESERVES THE RIGHT TO CHANGE OR MODIFY THIS TERMS AND
                  ...
                  zuss.in PRIVATE LIMITED MAY REQUIRE YOU TO PROVIDE YOUR DIRECT
                ...
                <li className="li4">
                  Zuss.in RESERVES THE RIGHT TO WITHDRAW OR DISCONTINUE OR
